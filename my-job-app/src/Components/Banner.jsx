  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        ...
        <form className='mt-10'>
            <div className='flex justify-center md:flex-row flex-col md:gap-2 gap-2'>
                <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset md:w-1/2 w-full'>
                    <input type="text" name='title' id='title' placeholder='Which job position are you looking for?'
